...
<Td width="350"><input name=from readonly value='<%=session.getAttribute("sssname")%>'style='width:350px'></td></tr>
...
try {
  ...
  while(rs.next()) {
	  ...
	  out.println("<option value='"+uname+"'> Administrator "+uname+"</option>");}
} catch(Exception e) {
